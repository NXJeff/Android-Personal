...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //setDrawerImage
//        ImageView mDrawerImage = (ImageView) findViewById(R.id.drawer_image);
//        mDrawerImage.setImageResource(R.drawable.navdrawer_cover);
//        mDrawerImage.setScaleType(ImageView.ScaleType.CENTER_CROP);

        mDrawerLayout.setDrawerShadow(R.drawable.drawer_shadow,
                GravityCompat.START);

        // Add Drawer Item to dataList
//        dataList.add(new DrawerItem(DrawerItemType.Image)); //image photo
