...
public class BaseReminder {
    ...
    public BaseReminder(Long id, String subject, String description, java.util.Date fromDate, java.util.Date toDate, java.util.Date atTime, Integer repeatType, String reminderType, Integer customRepeatMode, Integer color, Integer repeatEveryNDay, Integer dosesInTotal, Integer dosesPerDay, Boolean enabled, String status) {
        this.id = id;
