...
/** 
 * DAO for table BASE_MEAL.
*/
public class BaseMealDao extends AbstractDao<BaseMeal, Long> {

    public static final String TABLENAME = "BASE_MEAL";
    ...
    */
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'BASE_MEAL' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'BASE_MEAL'";
        db.execSQL(sql);
    }
