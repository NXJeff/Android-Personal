...
/** 
 * DAO for table BASE_REMINDER.
*/
public class BaseReminderDao extends AbstractDao<BaseReminder, Long> {

    public static final String TABLENAME = "BASE_REMINDER";
    ...
    */
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'BASE_REMINDER' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'BASE_REMINDER'";
        db.execSQL(sql);
    }
