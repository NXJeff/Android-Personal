...
public class BaseReminderDao extends AbstractDao<BaseReminder, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Color = new Property(9, Integer.class, "color", false, "COLOR");
        public final static Property RepeatEveryNDay = new Property(10, Integer.class, "repeatEveryNDay", false, "REPEAT_EVERY_NDAY");
        public final static Property DosesInTotal = new Property(11, Integer.class, "dosesInTotal", false, "DOSES_IN_TOTAL");
        public final static Property DosesPerDay = new Property(12, Integer.class, "dosesPerDay", false, "DOSES_PER_DAY");
        public final static Property Enabled = new Property(13, Boolean.class, "enabled", false, "ENABLED");
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'Reminder' (" + //
                ...
                "'COLOR' INTEGER," + // 9: color
                "'REPEAT_EVERY_NDAY' INTEGER," + // 10: repeatEveryNDay
                "'DOSES_IN_TOTAL' INTEGER," + // 11: dosesInTotal
                "'DOSES_PER_DAY' INTEGER," + // 12: dosesPerDay
                "'ENABLED' INTEGER," + // 13: enabled
    ...
    public BaseReminder readEntity(Cursor cursor, int offset) {
        BaseReminder entity = new BaseReminder( //
            ...
            cursor.isNull(offset + 9) ? null : cursor.getInt(offset + 9), // color
            cursor.isNull(offset + 10) ? null : cursor.getInt(offset + 10), // repeatEveryNDay
            cursor.isNull(offset + 11) ? null : cursor.getInt(offset + 11), // dosesInTotal
            cursor.isNull(offset + 12) ? null : cursor.getInt(offset + 12), // dosesPerDay
            cursor.isNull(offset + 13) ? null : cursor.getShort(offset + 13) != 0, // enabled
    ...
    public void readEntity(Cursor cursor, BaseReminder entity, int offset) {
        ...
        entity.setColor(cursor.isNull(offset + 9) ? null : cursor.getInt(offset + 9));
        entity.setRepeatEveryNDay(cursor.isNull(offset + 10) ? null : cursor.getInt(offset + 10));
        entity.setDosesInTotal(cursor.isNull(offset + 11) ? null : cursor.getInt(offset + 11));
        entity.setDosesPerDay(cursor.isNull(offset + 12) ? null : cursor.getInt(offset + 12));
        entity.setEnabled(cursor.isNull(offset + 13) ? null : cursor.getShort(offset + 13) != 0);
