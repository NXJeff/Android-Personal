...
public class MealDao extends AbstractDao<Meal, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property MealType = new Property(4, String.class, "mealType", false, "MEAL_TYPE");
    ...
    public Meal readEntity(Cursor cursor, int offset) {
        Meal entity = new Meal( //
            ...
            cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4), // mealType
    ...
    public void readEntity(Cursor cursor, Meal entity, int offset) {
        ...
        entity.setMealType(cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4));
