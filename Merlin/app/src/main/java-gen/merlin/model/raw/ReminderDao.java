...
public class ReminderDao extends AbstractDao<Reminder, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property FromDate = new Property(4, java.util.Date.class, "fromDate", false, "FROM_DATE");
        public final static Property ToDate = new Property(5, java.util.Date.class, "toDate", false, "TO_DATE");
        public final static Property AtTime = new Property(6, java.util.Date.class, "atTime", false, "AT_TIME");
        public final static Property RepeatType = new Property(7, Integer.class, "repeatType", false, "REPEAT_TYPE");
        public final static Property ReminderType = new Property(8, String.class, "reminderType", false, "REMINDER_TYPE");
        public final static Property CustomRepeatMode = new Property(9, Integer.class, "customRepeatMode", false, "CUSTOM_REPEAT_MODE");
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'reminder' (" + //
                ...
                "'FROM_DATE' INTEGER," + // 4: fromDate
                "'TO_DATE' INTEGER," + // 5: toDate
                "'AT_TIME' INTEGER," + // 6: atTime
                "'REPEAT_TYPE' INTEGER," + // 7: repeatType
                "'REMINDER_TYPE' TEXT," + // 8: reminderType
                "'CUSTOM_REPEAT_MODE' INTEGER," + // 9: customRepeatMode
    ...
    public Reminder readEntity(Cursor cursor, int offset) {
        Reminder entity = new Reminder( //
            ...
            cursor.isNull(offset + 4) ? null : new java.util.Date(cursor.getLong(offset + 4)), // fromDate
            cursor.isNull(offset + 5) ? null : new java.util.Date(cursor.getLong(offset + 5)), // toDate
            cursor.isNull(offset + 6) ? null : new java.util.Date(cursor.getLong(offset + 6)), // atTime
            cursor.isNull(offset + 7) ? null : cursor.getInt(offset + 7), // repeatType
            cursor.isNull(offset + 8) ? null : cursor.getString(offset + 8), // reminderType
            cursor.isNull(offset + 9) ? null : cursor.getInt(offset + 9), // customRepeatMode
    ...
    public void readEntity(Cursor cursor, Reminder entity, int offset) {
        ...
        entity.setFromDate(cursor.isNull(offset + 4) ? null : new java.util.Date(cursor.getLong(offset + 4)));
        entity.setToDate(cursor.isNull(offset + 5) ? null : new java.util.Date(cursor.getLong(offset + 5)));
        entity.setAtTime(cursor.isNull(offset + 6) ? null : new java.util.Date(cursor.getLong(offset + 6)));
        entity.setRepeatType(cursor.isNull(offset + 7) ? null : cursor.getInt(offset + 7));
        entity.setReminderType(cursor.isNull(offset + 8) ? null : cursor.getString(offset + 8));
        entity.setCustomRepeatMode(cursor.isNull(offset + 9) ? null : cursor.getInt(offset + 9));
